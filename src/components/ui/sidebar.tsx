      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] max-w-[86vw] border-r border-sidebar-border bg-sidebar p-0 text-sidebar-foreground shadow-2xl"
            style={
              {
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      className={cn(
        "h-7 w-7",
        // Coarse pointers get a 44x44 hit area without enlarging the icon.
        "relative [touch-action:manipulation] [@media(pointer:coarse)]:after:absolute [@media(pointer:coarse)]:after:left-1/2 [@media(pointer:coarse)]:after:top-1/2 [@media(pointer:coarse)]:after:h-11 [@media(pointer:coarse)]:after:w-11 [@media(pointer:coarse)]:after:-translate-x-1/2 [@media(pointer:coarse)]:after:-translate-y-1/2 [@media(pointer:coarse)]:after:content-['']",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
